...
class BookPropertyPage extends StatefulWidget {
  const BookPropertyPage({super.key});

  @override
  State<BookPropertyPage> createState() => _BookPropertyPageState();
}

class _BookPropertyPageState extends State<BookPropertyPage> {
                ...
                onPressed: () {
                  ...
                  Future.delayed(const Duration(milliseconds: 100), () async {
                    if (pickedStartDate != "" && pickedEndDate != "") {
                      ...
                      tenantService.bookpropertyhost();
                    } else {
                      if (pickedStartDate == "") {
                        setState(() {
                          startDateError = true;
