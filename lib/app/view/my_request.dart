    ...
    return Obx(
      () {
        if (getAllRequestsController.isLoading.value) {
          ...
          if (getAllRequestsController.requestList[0].data! != null) {
            if (getAllRequestsController.requestList[0].data!.isEmpty) {
              ...
              return ListView.builder(
                scrollDirection:
                    widget.isviewall == 1 ? Axis.vertical : Axis.horizontal,
                itemCount: getAllRequestsController.requestList[0].data!.length,
                                    ...
                                    children: [
                                      Text(
                                        data.title
                                                ...
                                                .substring(0, 1)
                                                .toUpperCase() +
                                            data.title.toString().substring(1),
